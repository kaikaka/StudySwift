//
//  TableDataSourcesViewController.swift
//  StudySwift
//
...
class TableDataSourcesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        startBtn = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: nil)
//        self.startBtn.title = "刷新"
        cancleBtn = UIBarButtonItem(title: "停止", style: .plain, target: self, action: nil)
        navigationItem.rightBarButtonItems = [startBtn, cancleBtn]
