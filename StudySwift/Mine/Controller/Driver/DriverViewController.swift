...
class DriverViewController: UIViewController {
    ...
    let query:UITextField = UITextField.init(frame: CGRect(x: 10, y: 100, width: 375, height: 50))
    let resultCount:UILabel = UILabel.init(frame: CGRect(x: 10, y: 200, width: 375, height: 50))
    let resultsTableView:UITableView = UITableView.init(frame: CGRect(x: 10, y: 300, width: 300, height: 300))
...
//        log.debug("results\(results.singers)")
