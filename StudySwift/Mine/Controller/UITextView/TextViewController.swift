...
//    UITextField 与 UITextView 原理是一样的
    ...
    override func viewDidLoad() {
        ...
        // 创建文本输入框
        let textField = UITextField(frame: CGRect(x: 10, y: 108, width: 200, height: 30))
...
//        self.textView()
    ...
    func textField() {
        // 创建文本输入框
        let inputField = UITextField(frame: CGRect(x: 10, y: 200, width: 200, height: 30))
        ...
        // 创建文本标签
        let label = UILabel(frame: CGRect(x: 20, y: 300, width: 350, height: 30))
        view.addSubview(label)

        // 创建按钮
        let button: UIButton = UIButton(type: .system)
        button.frame = CGRect(x: 20, y: 450, width: 40, height: 30)
...
//            }).disposed(by: disposeBag)
    ...
    func textView() {
        ...
        let textView = UITextView(frame: CGRect(x: 10, y: 150, width: 400, height: 400))
